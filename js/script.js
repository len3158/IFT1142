...
var tabCatalogue = [{"titre" : "Categorie...", "prix" : 0.00, "categ" : "Categorie...", "image" : " "},
                    
                    {"titre" : "Splatoon", "prix" : 70.95, "categ" : "jeux Videos", "image" : "splatoon.jpg"},
        ...
        var zoneCatalogue = document.getElementById("formProduit");
            for(var i=1;i<5;i++){
                ...
                var attribut = document.createAttribute("class"); 
                    attribut.value = "unItem";
                    element.setAttributeNode(attribut);  
                    element.innerHTML = "<img name="+"image"+" src=../images/"+tabCatalogue[i].image+" style=" + "width:250px;height:250px;><p name="+"titre"+">"+tabCatalogue[i].titre+"</p><p name="+"prix"+" value="+tabCatalogue[i].prix+">"+tabCatalogue[i].prix+" $</p>";
                    return element;
                };
	...
	for (i in tabCatalogue){
		if(tabCatalogue[i].categ == categChoisie){
            var produit = function creerItem(){
                ...
                attribut.value = "unItem";
                element.setAttributeNode(attribut);  
                element.innerHTML = "<img name="+"image"+" src=../images/"+tabCatalogue[i].image+" style=" + "width:250px;height:250px;><p name="+"titre"+">"+tabCatalogue[i].titre+"</p><p name="+"prix"+" value="+tabCatalogue[i].prix+">"+tabCatalogue[i].prix+" $</p><input type="+"checkbox"+" name="+tabCatalogue[i].titre+ " value="+tabCatalogue[i].prix+" /><br><label for="+"quantite"+">Quantite desiree: </label><input type="+"text "+"id="+"quantite "+"value="+" "+" >";
                    return element;
                };
